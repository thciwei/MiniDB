...
public class TransactionManagerTest {
    ...
    public void testMultiThread() {
        //文件已经存在则报错File already exists!
        tm = TransactionManager.create("D:/AllMyWork/MiniDB/tmp/tranmger_test");
        ...
        assert new File("D:/AllMyWork/MiniDB/tmp/tranmger_test.xid").delete();
